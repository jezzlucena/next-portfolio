    ...
    >
      <div className={styles.wrapper} ref={wrapper}>
        ...
        <div className={styles.detailsContainer}>
          <div className={`${styles.name} ${styles.loadingGradient}`}>{project.i18nKeys.name}</div>
          <div className={`${styles.subtitle} ${styles.loadingGradient}`}>
            <span className={styles.role}>{project.i18nKeys.role}</span>
            <span className={styles.company}>{project.i18nKeys.company}</span>
            <span className={styles.year}>{project.year}</span>
          </div>
          <div className={`${styles.description} ${styles.loadingGradient}`}>{project.i18nKeys.description}</div>
        </div>
      </div>
    </Link>
  );
